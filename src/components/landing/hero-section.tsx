    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-background via-background to-muted/30 py-20 md:py-32">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <div className="inline-block px-4 py-2 mb-6 text-sm font-medium bg-primary/10 text-primary rounded-full">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            ...
            Compare net salaries side-by-side with canton+municipality-level precision, expat regimes, and real deductions.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          <div className="flex flex-col items-center p-4 rounded-lg bg-card border">
            ...
            <p className="text-xs text-muted-foreground text-center">
              Canton+municipality level, expat regimes, real deductions
            </p>
          </div>
          <div className="flex flex-col items-center p-4 rounded-lg bg-card border">
            ...
            <p className="text-xs text-muted-foreground text-center">
              Side-by-side comparison, not scattered cost-of-living estimates
            </p>
          </div>
          <div className="flex flex-col items-center p-4 rounded-lg bg-card border">
            ...
            <p className="text-xs text-muted-foreground text-center">
              Open source, no paywalls, maintained by the community
            </p>
          </div>
          <div className="flex flex-col items-center p-4 rounded-lg bg-card border">
            ...
            <p className="text-xs text-muted-foreground text-center">
              Shareable links for colleagues and family
            </p>
          </div>
        </div>
      </div>
